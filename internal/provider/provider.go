...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-mpls/internal/eda/utils"
)
...
var _ provider.Provider = (*mplsProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &mplsProvider{version: ver}
	}
}

type mplsProvider struct {
	version string
}
...
func (p *mplsProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *mplsProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *mplsProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "mpls-v1alpha1"
	resp.Version = p.version
}

func (p *mplsProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAppGroupDataSource,
		NewDefaultLdpInterfaceDataSource,
		NewDefaultLdpInterfaceListDataSource,
		NewDefaultLdpRouterDataSource,
		NewDefaultLdpRouterListDataSource,
		NewLabelBlockDataSource,
		NewLabelBlockListDataSource,
		NewResourceListDataSource,
	}
}

func (p *mplsProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewDefaultLdpInterfaceResource,
		NewDefaultLdpRouterResource,
		NewLabelBlockResource,
	}
}
