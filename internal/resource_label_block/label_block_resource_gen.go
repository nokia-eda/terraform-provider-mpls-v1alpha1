...
func LabelBlockResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^LabelBlock$"), ""),
				},
				Default: stringdefault.StaticString("LabelBlock"),
			},
			...
			"name": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
				Description:         "name of the LabelBlock",
				MarkdownDescription: "name of the LabelBlock",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"spec": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"end_label": schema.Int64Attribute{
						Required:            true,
						Description:         "End label of the block.",
						MarkdownDescription: "End label of the block.",
						Validators: []validator.Int64{
							int64validator.Between(16, 1048575),
						},
					},
					"start_label": schema.Int64Attribute{
						Required:            true,
						Description:         "Start label of the block.",
						MarkdownDescription: "Start label of the block.",
						Validators: []validator.Int64{
							int64validator.Between(16, 1048575),
						},
					},
					"type": schema.StringAttribute{
						Required:            true,
						Description:         "Type of the label block.",
						MarkdownDescription: "Type of the label block.",
						Validators: []validator.String{
				...
				Required:            true,
				Description:         "LabelBlockSpec defines the desired state of LabelBlock",
				MarkdownDescription: "LabelBlockSpec defines the desired state of LabelBlock",
			},
			"status": schema.SingleNestedAttribute{
				...
				Optional:            true,
				Computed:            true,
				Description:         "LabelBlockStatus defines the observed state of LabelBlock",
				MarkdownDescription: "LabelBlockStatus defines the observed state of LabelBlock",
			},
		},
	}
}
...
func (t SpecType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	endLabelAttribute, ok := attributes["end_label"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`end_label is missing from object`)

		return nil, diags
	}

	endLabelVal, ok := endLabelAttribute.(basetypes.Int64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`end_label expected to be basetypes.Int64Value, was: %T`, endLabelAttribute))
	}

	startLabelAttribute, ok := attributes["start_label"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`start_label is missing from object`)

		return nil, diags
	}

	startLabelVal, ok := startLabelAttribute.(basetypes.Int64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`start_label expected to be basetypes.Int64Value, was: %T`, startLabelAttribute))
	}
	...
	return SpecValue{
		EndLabel:   endLabelVal,
		StartLabel: startLabelVal,
		SpecType:   typeVal,
		state:      attr.ValueStateKnown,
	}, diags
}
...
type SpecValue struct {
	EndLabel   basetypes.Int64Value  `tfsdk:"end_label"`
	StartLabel basetypes.Int64Value  `tfsdk:"start_label"`
...
func (v SpecValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["end_label"] = basetypes.Int64Type{}.TerraformType(ctx)
	attrTypes["start_label"] = basetypes.Int64Type{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.EndLabel.ToTerraformValue(ctx)
		...
		val, err = v.StartLabel.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["start_label"] = val
...
func (v SpecValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	attributeTypes := map[string]attr.Type{
		"end_label":   basetypes.Int64Type{},
		"start_label": basetypes.Int64Type{},
	...
	objVal, diags := types.ObjectValue(
		attributeTypes,
		map[string]attr.Value{
			"end_label":   v.EndLabel,
			"start_label": v.StartLabel,
			"type":        v.SpecType,
		})
...
func (v SpecValue) Equal(o attr.Value) bool {
	...
	if !v.EndLabel.Equal(other.EndLabel) {
		return false
	}

	if !v.StartLabel.Equal(other.StartLabel) {
		return false
	}
